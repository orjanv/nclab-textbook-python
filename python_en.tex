...
\noindent
{\em Failure to convert at least one operand in division 
to a real number can be a source of mistakes that are extremely hard to find.} 
Therefore, do not forget that\\

\begin{center}
{\color{red}\bf The result of division of two integers always is an integer.}
\vspace{4mm}
\end{center}
...
\PY{n+ne}{ValueError}\PY{p}{:} \PY{n}{negative} \PY{n}{number} \PY{n}{cannot} \PY{n}{be} \PY{n}{raised} \PY{n}{to} \PY{n}{a} \PY{n}{fractional} \PY{n}{power}
\end{Verbatim}
...
\end{verbatim}
While C++ is a great language, technical details like this 
...
\begin{itemize}
\item Understand how colors are composed in a computer.
...
\subsection{Plotting simple objects}

...
real numbers between 0 and 1. For the primary colors we have\\[-4mm]
...
With [0, 0, 0] one obtains black, with [1, 1, 1] white. This is illustrated in Fig. \ref{fig:rgb2}.\\[-7mm]
\begin{figure}[!ht]
\begin{center}
